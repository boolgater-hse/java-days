...
public class Floor {
    ...
    /**
     * Functions checks availability of floor
     *
     * @param elevatorId id of elevator that tries to stake out floor
     * @return true if floor was successfully staked out, false if not
     */
